...
package co.travelguide.home.di

import co.travelguide.home.data.HomeRepositoryImpl
import co.travelguide.home.data.remote.ApiKeyInterceptor
...
object HomeModule {
    ...
    @Provides
    @Singleton
    fun provideApi(networkJson: Json): ChatgptApi {
